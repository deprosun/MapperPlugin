...
public class MapperFromFieldImpl extends ASTWrapperPsiElement implements MapperFromField {

  public MapperFromFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Visitor visitor) {
    visitor.visitMapperFromField(this);
  }
